...
define(['underscore', 'jquery', 'brite', 'utils/logger', 'templates/WordEdit', 'templates/WordEditLangList', 'lib/jquery/jquery.transit'], function(_, $, brite, log, editTmpl, langTmpl) {
  var transitTime;
  transitTime = 200;
  return brite.registerView('WordEditView', {
    create: function(word) {
      ...
      return languageDAO.list().then(function(languages) {
        ...
        languageIDs = (_ref = word.Languages) != null ? _ref.split('\t') : void 0;
        if (languageIDs != null ? languageIDs.length : void 0) {
