...
define(['jquery', 'brite', 'templates', 'utils/logger', 'models/WordSearchModel', 'lib/jquery/jquery.transit'], function($, brite, templates, log, WordSearchModel) {
  return brite.registerView('WordSearch', {
    ...
    daoEvents: {
      'result; WordSearchModel': function(evt) {
        $('#right-panel').hide().html(templates.WordSearchList({
